...
let
  ...
  bootStage1 = pkgs.substituteAll {
    ...
    verbose = config.boot.initrd.verbose;
...

{
  options = {
    ...
    boot.initrd.verbose = mkOption {
      ...
      description =
        ''
          Verbosity of the initrd. Please note that disabling verbosity only
          removes the mandatory messages generated by our scripts. For a fullly
          silent boot you might want to set the two following configuration
